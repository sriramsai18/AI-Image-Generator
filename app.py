...
.gradio-container input[type="text"]:focus-visible,
.gradio-container input[type="number"]:focus-visible {
    outline: 2px solid #e63946 !important;
    outline-offset: 2px !important;
    box-shadow: 0 0 0 2px #080b0f, 0 0 14px rgba(230,57,70,0.85) !important;
    border-color: #e63946 !important;
}

.gradio-container button:focus-visible,
.gradio-container a:focus-visible,
.gradio-container input[type="range"]:focus-visible,
