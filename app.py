...
# Performance Optimization: channels_last memory format for faster 2D convolutions in UNet
...
def generate_image(prompt, negative_prompt, steps, guidance, width, height, seed):
    ...
    try:
        start = time.time()
        # Performance Optimization: torch.inference_mode disables autograd & view-tracking overhead
