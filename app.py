...
def generate_image(prompt, negative_prompt, steps, guidance, width, height, seed):
    ...
    try:
        start = time.time()
        # ⚡ Bolt Optimization: Use torch.inference_mode() to disable autograd tracking,
        # reduce memory allocation overhead, and accelerate PyTorch tensor computations during generation.
