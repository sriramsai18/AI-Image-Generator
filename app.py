...
# Optimize UNet and VAE memory layout for faster 2D convolutions (channels_last)
...
def generate_image(prompt, negative_prompt, steps, guidance, width, height, seed):
    ...
    try:
        start = time.time()
        # Use torch.inference_mode() for faster execution and reduced memory tracking overhead
