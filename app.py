...
# Memory format optimization: convert UNet and VAE to channels_last for faster tensor operations
...
def generate_image(prompt, negative_prompt, steps, guidance, width, height, seed):
    ...
    try:
        start = time.time()
        # Optimization: disable autograd tracking and view tracking overhead during inference
