...
def generate_image(prompt, negative_prompt, steps, guidance, width, height, seed):
    ...
    try:
        start = time.time()
        # Performance optimization: torch.inference_mode() disables autograd and view tracking
        # to accelerate inference execution speed and reduce memory consumption.
