...
# speed optimisation: channels_last memory format for faster 2D convolutions in UNet
...
def generate_image(prompt, negative_prompt, steps, guidance, width, height, seed):
    ...
    try:
        start = time.time()
        # speed optimisation: disable autograd tracking during inference to reduce memory and compute overhead
