...
# Optimize memory layout for PyTorch CNN/UNet operations (channels_last / NHWC layout)
...
def generate_image(prompt, negative_prompt, steps, guidance, width, height, seed):
    ...
    try:
        start = time.time()
        # Disable autograd overhead and tracking for faster inference and lower memory usage
